/**
 * Created by liuyufei on 18/08/18.
 *
 * webpack/ directory in the root project with an entry.js file.
 * This folder is for development only.
 * We’re keeping it out of the src directory
 * because we’re going to configure Webpack to pick up entry.js
 * and write a compiled version into the src files for Jekyll.
 *
 * Jekyll will then pick it up and serve it statically with the rest of the site.
 */
