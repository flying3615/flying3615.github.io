...
export const PROJECTS: Project[] = [
  {
    ...
    details: [
      'Designed and built an ingest pipeline that classifies repositories by business domain and indexes code symbols across a large multi-repo engineering organisation.',
      'Modelled cross-repo dependency and call-graph relationships in a graph database, enabling real-time queries over the full codebase topology.',
      'Exposed the knowledge graph as MCP tools so AI coding agents can answer "where is X defined?" and "who calls Y?" without ad-hoc grepping.',
      'Shipped a companion web portal for browsing the knowledge graph directly — used daily alongside the MCP tools by the engineering team.',
    ],
    links: [{ label: 'Case Study', href: './works/pinakes.html' }],
  },
  {
    name: 'Pinakes Plugin',
    eyebrow: 'Toitū Te Whenua LINZ · Internal Engineering Tooling',
    ...
    details: [
      'Packaged the Pinakes knowledge graph as Claude Code skills covering symbol lookup, call-graph navigation, and cross-repo dependency queries — all callable from within the AI editor.',
